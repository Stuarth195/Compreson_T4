...
Abre la App: Ejecuta MyZipCompreso.
  ...
  - Una vez que tengas tus archivos listos, presiona el botón verde azulado "Comprimir (.myzip)".

  - Ponle nombre a tu paquete (por defecto es paquete.myzip) y guárdalo donde quieras. Verás un mensaje de éxito cuando termine


2. Para Descomprimir (Recuperar tus archivos) 
Aquí hay una regla de oro :
Asegúrate de tener seleccionado en la pantalla el mismo algoritmo que usaste para comprimir. Si comprimiste con LZ77, tienes que tener seleccionado LZ77 para descomprimir.

  - Selecciona el algoritmo: (Si no lo has hecho ya).

  - Haz clic en "Descomprimir".

  - Encuentra el archivo .myzip que creaste antes.
...
Cositas a tener en cuenta
  ...
  - Regla de oro: LZ con LZ, Huffman con Huffman. Si intentas descomprimir un archivo LZ78 usando el botón de Huffman, es muy probable que obtengas texto ilegible o un error.
